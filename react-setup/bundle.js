...
var Root = function (_React$Component) {
  ...
  function Root() {
    ...
    _this.state = { hour: hour, minutes: minutes, seconds: seconds, timeOfDay: timeOfDay };
    _this.incrementTime();
    return _this;
  }
  ...
  _createClass(Root, [{
    ...
    value: function updateSeconds() {
      ...
      if (seconds + 1 === 60) {
        ...
        var stringNum = updatedSeconds.toString();
    ...
    value: function updateMinutes() {
      ...
      if (minutes + 1 === 60) {
        ...
        var updatedMinutes = minutes + 1;
        var stringNum = updatedMinutes.toString();
    ...
    value: function updateHour() {
      ...
      if (hour + 1 > 12) {
        ...
        var updatedHour = hour + 1;
        var stringNum = updatedHour.toString();
        if (updatedHour < 10) {
